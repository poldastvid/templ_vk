...
const string VK::Attachment::Audio::type = "audio";//Тип Аудио
const string VK::Attachment::Photo::type = "photo";//Тип Фото
const string VK::Attachment::Document::type = "doc";//Тип Документ
//вытаскиваем type parsed_type
...
//Вытаскивает параметры из аудио title artist duration url
...
//Вытаскивает параметры из фото text  direct_url(странным способом) 
...
//Парсит название ext type size url докумкента
...
//Парсит Имя фАМИЛИЮ И ИД ПОЛЬЗОВАТЕЛЯ
